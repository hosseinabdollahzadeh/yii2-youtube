...
class VideoController extends Controller
{
    ...
    public function actionLike($id)
    {
        ...
        $videoLikeDislike = VideoLike::find()
            ->userIdVideoId($userId, $id)->one();

        if (!$videoLikeDislike) {
            $this->saveLikeDislike($id, $userId, VideoLike::TYP_LIKE);
        } else if ($videoLikeDislike->type == VideoLike::TYP_LIKE) {
    ...
    public function actionDislike($id)
    {
        ...
        if (!$videoLikeDislike) {
            $this->saveLikeDislike($id, $userId, VideoLike::TYP_DISLIKE);
        } else if ($videoLikeDislike->type == VideoLike::TYP_DISLIKE) {
            $videoLikeDislike->delete();
        } else {
            $videoLikeDislike->delete();
            $this->saveLikeDislike($id, $userId, VideoLike::TYP_DISLIKE);
